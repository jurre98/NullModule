...
## 💬 Discussions, Ideas & Bugs
Since this is a collaborative project, communication is key!
* Use the **Discussions** tab at the top of this page for general ideas, brainstorming, and sharing progress.
* Use the **Issues** tab to report specific bugs (e.g., a mistake in the BOM or a schematic error) or to claim a specific task.
